      ...
      <div className="hero-cta p-6 text-center bg-gray-100 rounded-lg">
        ...
        {imageUrl && (
          <img
            src={imageUrl}
            alt={imageAlt || ""}
            className="my-4 mx-auto max-w-full h-auto rounded"
          />
        )}
        <RichText
          tagName="h1"
    ...
    return (
      <div className="hero-cta p-6 text-center bg-gray-100 rounded-lg">
        ...
        {heading ? (
          ...
          <h1 className="text-3xl font-bold mb-4 text-gray-400">Heading</h1>
        )}
        {buttonText && buttonUrl ? (
          ...
          <a
            href="#"
            className="inline-block px-6 py-3 bg-blue-400 text-white rounded cursor-not-allowed"
          >
            Button
          </a>
        )}
